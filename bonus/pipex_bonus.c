...
/*   Updated: 2024/02/08 10:09:32 by tamehri          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	here_doc(t_pip *pipex)
{
	...
	while (1)
	{
		...
		if (ft_strlen(line) - 1 == ft_strlen(pipex->delimiter) && \
		!ft_strncmp(line, pipex->delimiter, ft_strlen(line) - 1))
		{
			free(line);
			break ;
		}
...
int	main(int ac, char **av, char **environ)
{
	...
	if (ft_strlen(av[1]) == 8 && 0 == ft_strncmp(av[1], \
	"here_doc", ft_strlen(av[1])))
	{
